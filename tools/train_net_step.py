...
def main():
    ...
    if args.dataset == "coco2014_minival":
    ...
    elif args.dataset == "densepose_coco2014":
        cfg.TRAIN.DATASETS = ('dense_coco_2014_train',)
        cfg.MODEL.NUM_CLASSES = 2
    elif args.dataset == "densepose_coco2014_minival":
        cfg.TRAIN.DATASETS = ('dense_coco_2014_minival',)
        cfg.MODEL.NUM_CLASSES = 2
    else:
